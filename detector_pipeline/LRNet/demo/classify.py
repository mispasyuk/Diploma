...
from demo.utils.model import *
from demo.configs import load_yaml
...
def main():
    ...
    args_model = load_yaml("LRnet/demo/configs/args_model.yaml")
    args_inference = load_yaml("LRnet/demo/configs/args_inference.yaml")
